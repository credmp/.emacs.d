;;; arjen2-theme.el --- custom theme for faces

;;; Commentary:
;;
;;; Arjen2 based on Tomorrow Night Theme
;;
...
(deftheme arjen2
  "A Pastel Coloured Theme - based on tomorrow-theme")
...
(let ((background "#1d1f21")
  ...
  (custom-theme-set-faces
   ...
   ;; Font-lock stuff
   `(font-lock-builtin-face ((t (:foreground ,aqua :weight bold))))
   `(font-lock-comment-face ((t (:foreground ,comment))))
   `(font-lock-constant-face ((t (:foreground ,aqua :weight bold))))
   ...
   `(ecb-default-highlight-face ((t (:background ,selection))))
...
(provide-theme 'arjen2)

;;; arjen2-theme.el ends here
